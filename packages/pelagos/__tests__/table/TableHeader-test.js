...
describe('TableHeader', () => {
	...
	describe('behaviour', () => {
		...
		it('calls onResize when arrow left is pressed', () => {
			...
			wrapper.find('.Table__resizeHandle').simulate('keydown', {key: 'ArrowLeft', target: {closest}, preventDefault});
		...
		it('calls onResize when arrow right is pressed', () => {
			...
			wrapper.find('.Table__resizeHandle').simulate('keydown', {key: 'ArrowRight', target: {closest}, preventDefault});
			expect(preventDefault.mock.calls).toEqual([[]]);
		...
		it('calls onResize when page down is pressed', () => {
			...
			wrapper.find('.Table__resizeHandle').simulate('keydown', {key: 'PageDown', target: {closest}, preventDefault});
			expect(preventDefault.mock.calls).toEqual([[]]);
		...
		it('calls onResize when page up is pressed', () => {
			...
			wrapper.find('.Table__resizeHandle').simulate('keydown', {key: 'PageUp', target: {closest}, preventDefault});
			expect(preventDefault.mock.calls).toEqual([[]]);

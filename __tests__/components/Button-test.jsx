...
describe('Button', () => {
	describe('rendering', () => {
		it('renders expected elements when onClick is not specified', () => {
			const wrapper = shallow(<Button componentId="test" text="Test" />);
			expect(wrapper.getElement()).toMatchSnapshot();
		});

		it('renders expected elements when onClick is specified', () => {
			const wrapper = shallow(<Button componentId="test" text="Test" onClick={jest.fn()} />);
			expect(wrapper.getElement()).toMatchSnapshot();
		});

		it('renders expected elements when className is set', () => {
			const wrapper = shallow(<Button componentId="test" text="Test" className="testClass" />);
			expect(wrapper.getElement()).toMatchSnapshot();
		});

		it('renders expected elements when size is small', () => {
			const wrapper = shallow(<Button componentId="test" text="Test" size="small" />);
			expect(wrapper.getElement()).toMatchSnapshot();
		});

		it('renders expected elements when active is true', () => {
			const wrapper = shallow(<Button componentId="test" text="Test" active />);
			expect(wrapper.getElement()).toMatchSnapshot();
		});

		it('renders expected elements when disabled is true', () => {
			const wrapper = shallow(<Button componentId="test" text="Test" disabled />);
			expect(wrapper.getElement()).toMatchSnapshot();
		});

		it('renders expected elements when both size is small and disabled is true', () => {
			const wrapper = shallow(<Button componentId="test" text="Test" size="small" disabled />);
			expect(wrapper.getElement()).toMatchSnapshot();
		});

		it('renders expected elements when disabled is true and className is set', () => {
			const wrapper = shallow(<Button componentId="test" text="Test" disabled className="testClass" />);
			expect(wrapper.getElement()).toMatchSnapshot();
		});
	...
	describe('behaviour', () => {
		it('calls onClick when the button is clicked', () => {
			...
			const wrapper = shallow(<Button componentId="test" text="Test" onClick={onClick} />);
		...
		it('does not call onClick when the button is clicked if disabled is true', () => {
			const onClick = jest.fn();
			const wrapper = shallow(<Button componentId="test" text="Test" disabled onClick={onClick} />);
			wrapper.simulate('click');
		...
		it('calls onFocus when the button receives the focus', () => {
			...
			const wrapper = shallow(<Button componentId="test" text="Test" onFocus={onFocus} />);
		...
		it('calls onBlur when the button loses the focus', () => {
			...
			const wrapper = shallow(<Button componentId="test" text="Test" onBlur={onBlur} />);
